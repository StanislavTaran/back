...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/education_institution.EducationInstitution"
                            }
                        }
                    },
                    "400": {
        ...
        "/userEducation": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User education data",
                        "name": "userData",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user_education.CreateUserEducationDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/user.UploadFileInfo"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "user_education.CreateUserEducationDTO": {
            "type": "object",
            "properties": {
                "eduInstitutionId": {
                    "type": "integer"
