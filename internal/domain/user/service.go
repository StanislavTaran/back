...
func (us *Service) GetFullUserInfoById(ctx context.Context, id string) (*FullUserInfoOutputDTO, error) {
...
func (us *Service) Create(ctx context.Context, dto CreateUserInputDTO) (id string, err error) {
